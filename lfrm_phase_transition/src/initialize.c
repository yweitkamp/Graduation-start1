...
//	{
//		if(i%2==1)
//		sum1+=expfun(betag,a +h*(double)i);
//		else
//		sum2+=expfun(betag,a +h*(double)i);
//	}
//
//	ans=h*( expfun(betag,a) + expfun(betag,b) + 4*sum1 + 2*sum2)/3;
...
//	beta=71.679776460888007;
//	beta=1.233301909196179;
//	beta=0.074795044564105;
	beta=0.773861928246731;
