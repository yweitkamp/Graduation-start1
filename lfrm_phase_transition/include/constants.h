...
#define bubblegrowth 0
#define constmassflux 1.0000000000000E-01

/* Calculation options */
#define Implicity                0.0   // Diffusion   0.5 --> CRANK NICHOLSON, 1.0 --> Imlicit, 0.0 --> Euler backward Explicit
#define Implicit_Conv            0.0   // Convection  0.0 --> False, 1.0 --> True
