...
extern  double  CNVFLX_CONSRV_XT(int i, int j, int k);
extern  double  CNVFLX_CONSRV_YT(int i, int j, int k);
extern  double  CNVFLX_CONSRV_ZT(int i, int j, int k);
...
extern	double  getavgvelocityinbubble(void);
